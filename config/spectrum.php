...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The base URL for your API server. This will be used in the OpenAPI spec.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The base path for your API. This will be used in the server URL.
    |
    */
    'base_path' => '/api',
    ...
    */
    'tags' => [
        ...
        'api/cart*' => 'Cart',
        'api/orders*' => 'Orders',
        'api/admin/revenue' => 'Admin - Revenue',
    ],
